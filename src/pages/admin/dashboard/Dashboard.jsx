...
function Dashboard() {
  ...
  const { mode, products, orders, user } = context;
  return (
    <Layout>
      <section className="text-gray-600 body-font mt-10 mb-10 h-screen-auto">
        <div className="container px-5 mx-auto mb-10">
          <div className="flex flex-wrap justify-evenly -m-4 text-center">
